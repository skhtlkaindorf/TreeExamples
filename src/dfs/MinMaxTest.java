...
public class MinMaxTest {
	...
	public void getMinMaxSingleResult() {
		List<String> ls = ts.getMinMaxPreOrder(ts.getRoot(), 1.0, 1.5);
	...
	public void getMinMaxSomeResults1() {
		List<String> ls = ts.getMinMaxPreOrder(ts.getRoot(),1.75, 1.92);
	...
	public void getMinMaxSomeResults2() {
		List<String> ls = ts.getMinMaxPreOrder(ts.getRoot(),1.92, 2.1);
		assertEquals(3, ls.size());
	...
	public void getMinMaxAlmostAllResults() {
		List<String> ls = ts.getMinMaxPreOrder(ts.getRoot(),1.69, 2.1);
	...
	public void getMinMaxNoResult() {
		List<String> ls = ts.getMinMaxPreOrder(ts.getRoot(),1.0, 1.2);
		assertEquals(0, ls.size());
		ls = ts.getMinMaxPreOrder(ts.getRoot(),2.4, 2.5);
		assertEquals(0, ls.size());
	}
}
